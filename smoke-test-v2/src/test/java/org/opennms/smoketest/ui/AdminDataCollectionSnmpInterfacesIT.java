...
public class AdminDataCollectionSnmpInterfacesIT extends OpenNMSSeleniumIT {
    ...
    public void canRenderPage() throws Exception {
        ...
        List<WebElement> interfaces = OpenNMSSeleniumIT.driver.findElements(By.cssSelector("onms-interfaces-config td.ng-binding"));
        Assert.assertNotNull(interfaces);
        Assert.assertEquals(20, interfaces.size());
        // 1 column: collect
        List<WebElement> collect = OpenNMSSeleniumIT.driver.findElements(By.cssSelector("onms-interfaces-config td input"));
