...
//            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Grafana Endpoints"));
//            return this;
//        }
//
//        public List<UIGrafanaEndpoint> getEndpoints() {
//            return execute(() -> OpenNMSSeleniumIT.driver.findElements(By.xpath("//table/tbody/tr"))
//                    .stream()
//                    .map(row -> {
...
//                        new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(webDriver -> !row.findElements(By.xpath("./td")).get(2).getText().contains("****"));
...
//                        new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Add Grafana Endpoint"));
//                    });
//        }
//
...
//                new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Edit Grafana Endpoint"));
//            });
//        }
//
...
//                new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Delete Endpoint"));
...
//            execute(() -> new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(ExpectedConditions.numberOfElementsToBe(By.id("endpointModal"), 0)));
//        }
//    }
