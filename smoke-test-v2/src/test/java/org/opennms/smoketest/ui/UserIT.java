...
public class UserIT extends OpenNMSSeleniumIT {
    ...
    public void setUp() throws Exception {
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/account/selfService/index.jsp");
    }

    @Test
    public void testExpectedTextAndLinksArePresent() throws Exception {
        final List<WebElement> headers = OpenNMSSeleniumIT.driver.findElements(By.xpath("//div[@class='card-header']/span"));
    ...
    public void testSubmitWithWrongPassword() throws InterruptedException {
        OpenNMSSeleniumIT.driver.findElement(By.linkText("Change Password")).click();
        ...
        OpenNMSSeleniumIT.driver.findElement(By.cssSelector("button[type=submit]")).click();
    ...
    public void testUsersAndGroups() throws Exception {
        ...
        OpenNMSSeleniumIT.driver.findElement(By.xpath("//div[@class='card-header']/span[text()='Details for Group: " + GROUP_NAME + "']"));
