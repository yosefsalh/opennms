...
package org.opennms.smoketest.ui.topology;
...
public class GraphMLTopologyIT extends OpenNMSSeleniumIT {
    ...
    private void createDummyNodes() throws IOException, InterruptedException {
        ...
        final String foreignSourceXML = "<foreign-source name=\"" + OpenNMSSeleniumIT.REQUISITION_NAME + "\">\n" +
                ...
                "<policies/>\n" +
                "</foreign-source>";
        createForeignSource(AbstractOpenNMSSeleniumHelper.REQUISITION_NAME, foreignSourceXML);
        ...
        String requisitionXML = "<model-import foreign-source=\"" + OpenNMSSeleniumIT.REQUISITION_NAME + "\">" +
                                ...
                                "   </node>" +
                                "</model-import>";
        createRequisition(AbstractOpenNMSSeleniumHelper.REQUISITION_NAME, requisitionXML, 2);
    ...
    private static HttpClientWrapper createClientWrapper() {
        ...
        wrapper.addBasicCredentials(AbstractOpenNMSSeleniumHelper.BASIC_AUTH_USERNAME, AbstractOpenNMSSeleniumHelper.BASIC_AUTH_PASSWORD);
        return wrapper;
    }
