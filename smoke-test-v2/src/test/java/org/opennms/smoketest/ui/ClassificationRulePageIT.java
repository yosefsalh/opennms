...
public class ClassificationRulePageIT extends OpenNMSSeleniumIT {
    ...
    public void verifyErrorMessageReset() {
        ...
        assertThat(true, is(OpenNMSSeleniumIT.driver.findElement(By.id("classifyError.dstPort")).isDisplayed()));
        assertThat(false, is(OpenNMSSeleniumIT.driver.findElement(By.id("classification-response")).isDisplayed()));
        ...
        assertThat(false, is(OpenNMSSeleniumIT.driver.findElement(By.id("classifyError.dstPort")).isDisplayed()));
        assertThat(true, is(OpenNMSSeleniumIT.driver.findElement(By.id("classification-response")).isDisplayed()));
    ...
    private class Page {
        ...
        public Page open() {
            OpenNMSSeleniumIT.driver.get(url);
            new WebDriverWait(OpenNMSSeleniumIT.driver, 15).until((driver) -> getTabs().size() == expectedTabs.size());
            return this;
        }
        ...
        public List<Tab> getTabs() {
            return execute(() -> {
                final List<WebElement> tabElements = OpenNMSSeleniumIT.driver.findElements(By.xpath("//ul[@id='tabs']//li/a[@data-name]"));
                return tabElements.stream().map(eachTab -> {
                    final String name = eachTab.getAttribute("data-name");
                    final List<WebElement> spanElements = OpenNMSSeleniumIT.driver.findElements(By.xpath("//ul[@id='tabs']//li/a[@data-name='" + name + "']/span"));
    ...
    private class Tab {
        ...
        public void click() {
            getElement().click();
            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until((ExpectedCondition<Boolean>) input -> page.getTab(name).isActive());
        }

        public WebElement getElement() {
            return execute(() -> OpenNMSSeleniumIT.driver.findElement(By.xpath("//ul[@id='tabs']//li/a[@data-name='" + name + "']")));
        }
    ...
    private class SettingsTab {
        ...
        public List<Group> getGroups() {
            return execute(() -> OpenNMSSeleniumIT.driver.findElements(By.xpath("//table/tbody/tr[@data-row]"))
                    .stream()
                    .map(row -> {
        ...
        public void refresh() {
            OpenNMSSeleniumIT.driver.findElement(By.id("action.refresh")).click();
            sleep(DEFAULT_WAIT_TIME);
        }
    }
    ...
    private class Group {
        ...
        public void setEnabled(boolean enabled) {
            if (isEnabled() != enabled) {
                execute(() -> {
                    // Toggle
                    final WebElement toggleElement = OpenNMSSeleniumIT.driver.findElement(By.id(String.format("action.%s.toggle", name)));
                    Actions actions = new Actions(OpenNMSSeleniumIT.driver);
                    ...
                    new WebDriverWait(OpenNMSSeleniumIT.driver, 5)
                            .until(input -> {
        ...
        private GroupData getGroupData() {
            return execute(() -> {
                final List<WebElement> columns = OpenNMSSeleniumIT.driver.findElements(By.xpath("//table/tbody/tr[@data-row='" + this.name + "']/td"));
    ...
    private class RuleModal {
        ...
        public RuleModal setInput(RuleDTO rule) {
            ...
            execute(() -> {
                OpenNMSSeleniumIT.driver.findElements(By.xpath("//span/a[@name='remove-protocol']")).forEach(element -> element.click());
                return null;
            });
        ...
        private void ensureClosed() {
            execute(() -> new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(ExpectedConditions.numberOfElementsToBe(By.id("ruleModal"), 0)));
        }
    ...
    private class GroupTab {
        ...
        public boolean isEditable() {
            return execute(() -> OpenNMSSeleniumIT.driver.findElement(By.id("action.addRule"))).isDisplayed();
        }
        ...
        public RuleModal newModal() {
            return new RuleModal()
                    .open(() -> {
                        ...
                        new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Create Classification Rule"));
                    });
        }
        ...
        public RuleModal editModal(int position) {
            return new RuleModal()
                    .open(() -> {
                        ...
                        new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Edit Classification Rule"));
                    });
        }
        ...
        public List<RuleData> getRules() {
            return execute(() -> {
                    final List<WebElement> rows = OpenNMSSeleniumIT.driver.findElements(By.xpath("//div//table/tbody/tr"));
        ...
        public void deleteGroup(int position) {
            execute(() -> {
                ...
                new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(ExpectedConditions.numberOfElementsToBe(By.id(deleteActionId), 0));
                return null;
            });
        }
        ...
        public void navigateToPage(int page) {
            ...
            execute(() -> new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(
        ...
        public void deleteAll() {
            if (!getRules().isEmpty()) {
                new DeleteAllButton(OpenNMSSeleniumIT.driver).click();
                sleep(DEFAULT_WAIT_TIME);
            }
        }
