...
public class StatisticsReportsIT extends OpenNMSSeleniumIT {
    ...
    public void setUp() throws Exception {
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/statisticsReports/index.htm");
    }

    // TODO MVR this is not really a ui page it?!
//    @Test
//    public void hasReportLinkThatMatchDescription() throws Exception {
//        Date startOfTest = new Date();
//
//        HibernateDaoFactory daoFactory = OpenNMSSeleniumIT.stack.postgres().getDaoFactory();
