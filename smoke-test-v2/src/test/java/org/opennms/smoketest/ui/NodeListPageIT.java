...
public class NodeListPageIT extends OpenNMSSeleniumIT {
    ...
    public void testNodesWithFlows() {
        OpenNMSSeleniumIT.driver.get(this.getBaseUrlInternal() + "opennms/element/nodeList.htm?flows=true");
        assertThat(Iterables.transform(OpenNMSSeleniumIT.driver.findElements(By.xpath("//div[@class='NLnode']//a")), WebElement::getText),
                containsInAnyOrder("TestMachine loc1node2", "TestMachine loc2node2"));
    }

    @Test
    public void testNodesWithoutFlows() {
        OpenNMSSeleniumIT.driver.get(this.getBaseUrlInternal() + "opennms/element/nodeList.htm?flows=false");
        assertThat(Iterables.transform(OpenNMSSeleniumIT.driver.findElements(By.xpath("//div[@class='NLnode']//a")), WebElement::getText),
    ...
    public void testAvailableLocations() throws Exception {
        ...
        assertThat(Iterables.transform(OpenNMSSeleniumIT.driver.findElements(By.xpath("//select[@id='monitoringLocation']//option")), WebElement::getText),
