...
public class EditInRequisitionIT extends OpenNMSSeleniumIT {
    ...
    public void before() throws Exception {
        createRequisition();
        createNode();
        OpenNMSSeleniumIT.driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
    ...
    public void testIfNotRequisition() throws Exception {
        ...
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/element/node.jsp?node=my-foreign-source:my-foreign-id");
        ...
        OpenNMSSeleniumIT.driver.manage().timeouts().implicitlyWait(1, TimeUnit.SECONDS);
    ...
    public void testIfDeployed() throws Exception {
        ...
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/element/node.jsp?node=" + OpenNMSSeleniumIT.REQUISITION_NAME + ":my-foreign-id-1");
    ...
    public void testIfPending() throws Exception {
        ...
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/element/node.jsp?node=" + OpenNMSSeleniumIT.REQUISITION_NAME + ":my-foreign-id-2");
