...
public class EventsPageIT extends OpenNMSSeleniumIT {
    ...
    public void setUp() throws Exception {
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/event/list");
    }
    ...
    public void testNodeIdNotFoundPage() throws InterruptedException {
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/event/detail.jsp?id=999999999");
        OpenNMSSeleniumIT.driver.findElement(By.xpath("//p[text()='Event not found in database.']"));
    }
