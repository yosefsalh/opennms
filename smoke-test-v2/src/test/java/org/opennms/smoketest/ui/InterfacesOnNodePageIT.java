...
public class InterfacesOnNodePageIT extends OpenNMSSeleniumIT {
    ...
    public void testNodePage() throws Exception {
        ...
        List<WebElement> elements = OpenNMSSeleniumIT.driver.findElements(By.cssSelector("div.tab-pane.ng-scope.active td.ng-binding"));
        ...
        elements = OpenNMSSeleniumIT.driver.findElements(By.cssSelector("div.tab-pane.ng-scope.active td.ng-binding"));
