...
public class AlarmsPageIT extends OpenNMSSeleniumIT {
    ...
    public void createAlarm() throws Exception {
        ...
        final RestClient restClient = environment.opennms().getRestClient();
    ...
    protected void alarmsPage() {
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/alarm/index.htm");
    }
    ...
    public void testAlarmIdNotFoundPage() throws InterruptedException {
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/alarm/detail.htm?id=999999999");
