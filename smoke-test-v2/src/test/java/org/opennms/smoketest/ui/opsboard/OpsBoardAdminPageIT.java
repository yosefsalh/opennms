...
package org.opennms.smoketest.ui.opsboard;
...
import org.opennms.smoketest.ui.OpenNMSSeleniumIT;
...
public class OpsBoardAdminPageIT extends OpenNMSSeleniumIT {
    ...
    public void testHeaderHiddenForTopologyUI() {
        ...
        try {
            ...
            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(not(pageContainsText("Access denied")));
            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Topology"));
            ...
            await().atMost(1, TimeUnit.MINUTES)
                    ...
                    .until(() -> OpenNMSSeleniumIT.driver.switchTo().parentFrame()
    ...
    public void testHeaderHiddenForNodeMap() {
        ...
        try {
            setImplicitWait(1, TimeUnit.SECONDS);
            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(not(pageContainsText("Access denied")));
            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Map"));
    ...
    public void canCreateAndPreview() {
        ...
        try {
            setImplicitWait(1, TimeUnit.SECONDS);
            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(not(pageContainsText("Access denied")));
            new WebDriverWait(OpenNMSSeleniumIT.driver, 5).until(pageContainsText("Surveillance view"));
        } finally {
            setImplicitWait();
        }
    }
