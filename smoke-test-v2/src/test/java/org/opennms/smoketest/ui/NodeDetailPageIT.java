...
public class NodeDetailPageIT extends OpenNMSSeleniumIT {
    ...
    public void canUseViewInTopology() throws Exception {
        try {
            ...
            environment.opennms().getRestClient().sendEvent(eventBuilder.getEvent());
    ...
    public void checkMaximumNumberOfInterfaces() throws Exception {
        try {
            ...
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.id("availability-box")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.1")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.2")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.3")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.4")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.5")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.6")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.7")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.8")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.9")).size());
            Assert.assertEquals(1, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.10")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.11")).size());

            OpenNMSSeleniumIT.driver.get(getBaseUrlInternal()+"opennms/element/node.jsp?node=test:nodeWith11Interfaces");

            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.id("availability-box")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.1")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.2")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.3")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.4")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.5")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.6")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.7")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.8")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.9")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.10")).size());
            Assert.assertEquals(0, OpenNMSSeleniumIT.driver.findElements(By.linkText("192.168.1.11")).size());
        } finally {
    ...
    public void verifyTimeline() throws Exception {
        try {
            ...
            OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/element/node.jsp?node=smoketests:nodeForeignId");
                    ...
                    .until(() -> {
                        ...
                        if (timelineImages.size() >= 2) {
                            for (final WebElement timelineImage : timelineImages) {
                                final Object result = ((JavascriptExecutor) OpenNMSSeleniumIT.driver).executeScript("return arguments[0].complete && typeof arguments[0].naturalWidth != \"undefined\" && arguments[0].naturalWidth > 0", timelineImage);
    ...
    public void verifyNodeNotFoundMessageIsShown() {
        ...
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/element/node.jsp?node=12345");
        pageContainsText(NODE_NOT_FOUND);

        final String NODE_ID_NOT_FOUND = "Node ID Not Found";
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/element/node.jsp?node=abc");
        pageContainsText(NODE_ID_NOT_FOUND);
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/element/node.jsp?node=ab:cd");
        pageContainsText(NODE_ID_NOT_FOUND);
    }
}
