...
public class JmxConfigurationGeneratorIT extends OpenNMSSeleniumIT {
    ...
    public void before() throws InterruptedException {
        OpenNMSSeleniumIT.driver.get(getBaseUrlInternal() + "opennms/admin/jmxConfigGenerator.jsp");
    ...
    public void testClickOnHeaderLinkWorks() {
        ...
        Collection<WebElement> errorPopups = OpenNMSSeleniumIT.driver.findElements(By.cssSelector("div[class=\"v-errormessage\"]"));
    ...
    private void waitForAndClickOn(By by) {
        final Wait<RemoteWebDriver> wait = new FluentWait<>(OpenNMSSeleniumIT.driver)
    ...
    protected void configureJMXConnection(final boolean skipDefaultVM) throws Exception {
        ...
        final WebDriverWait shortWait = new WebDriverWait(OpenNMSSeleniumIT.driver, 10);
    ...
    protected void selectVaadinFrame() {
        OpenNMSSeleniumIT.driver.switchTo().frame(0);
    }
    ...
    private void selectNodeByName(final String name, boolean select) throws InterruptedException {
        ...
        new Actions(OpenNMSSeleniumIT.driver).contextClick(findElementByXpath(treeNodeXpath)).perform(); // right click
