...
public class DatabaseReportIT extends OpenNMSSeleniumIT {
    ...
    private void verify() {
        ...
        OpenNMSSeleniumIT.driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        ...
        List<WebElement> errorElements = OpenNMSSeleniumIT.driver.findElements(By.xpath("//div[@class=\"alert alert-danger\"]"));
