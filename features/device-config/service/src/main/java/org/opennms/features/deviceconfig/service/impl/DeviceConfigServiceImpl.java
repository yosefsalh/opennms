...
public class DeviceConfigServiceImpl implements DeviceConfigService {
    ...
    @Override
    public Optional<byte[]> getDeviceConfig(String ipAddress, String location, String configType, int timeout) throws IOException {
        CompletableFuture<PollerResponse> future = pollDeviceConfig(ipAddress, location, configType);
        try {
            ...
            if (response != null && response.getPollStatus() != null && response.getPollStatus().getDeviceConfig() != null) {
                return Optional.of(response.getPollStatus().getDeviceConfig());
            }
